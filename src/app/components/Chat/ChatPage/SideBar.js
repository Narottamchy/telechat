...
const Sidebar = () => {
  ...
  return (
    <>
      {showSidebar ? (
        <svg
        className="w-7 h-7 flex text-4xl text-black items-center cursor-pointer fixed left-6 bottom-6 z-50"
      ...
      <div
        className={`top-0 w-[15vw] text-black fixed bg-white h-full z-40  ease-in-out duration-300 ${showSidebar ? "translate-x-0 " : "-translate-x-64"
          }`}
      >
        <div className="flex flex-col py-8 pl-4 pr-4 w-64 bg-white flex-shrink-0">
          ...
          <div className="flex flex-col items-center bg-indigo-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg">
            <div className="h-20 w-20 rounded-full border overflow-hidden">
              <img
                src="https://img.freepik.com/free-vector/man-with-mustache_1308-83591.jpg?w=740&t=st=1686580509~exp=1686581109~hmac=30caeb99733b36ccaa2d45c2032a26a7ad321aa07ae69da87e648d832e138f3e"
                alt="Avatar"
                className="h-full w-full"
              />
            </div>
            <div className="text-sm font-semibold mt-2">Narottam</div>
            <div className="text-xs text-gray-500">Million</div>
